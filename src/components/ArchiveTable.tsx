  ...
  return (
    <div className="relative w-full">
      ...
      <div className="flex flex-col border-t border-white/10 w-full">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-4 py-6 px-8 text-xs font-mono text-white/40 uppercase tracking-widest border-b border-white/10">
        ...
        {projectsData.map((project, index) => (
          <Link 
            ...
            key={project.id}
            className="group block lg:grid lg:grid-cols-12 lg:gap-4 py-6 lg:py-12 px-4 lg:px-8 border-b border-white/5 lg:hover:bg-white/[0.03] transition-colors items-center cursor-pointer relative"
